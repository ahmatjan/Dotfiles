...
(ede-add-project-autoload (ede-project-autoload "ant" :name "Ant" :file 'ede/ant :proj-file ede-ant-project-file-name :proj-root 'ede-ant-project-root :load-type 'ede-ant-load :class-sym 'ede-ant-project :new-p nil :safe-p t))

;;;***

;;;### (autoloads (ede-arduino-load ede-arduino-file ede-arduino-root)
;;;;;;  "ede/arduino" "arduino.el" (20716 7429))
...
;;;;;;  "ede/cpp-root" "cpp-root.el" (20716 7429))
...
;;;;;;  ede-customize-project) "ede/custom" "custom.el" (20716 7429))
...
;;;***

;;;### (autoloads (ede-find-file) "ede/files" "files.el" (20716 7429))
...
;;;;;;  "ede/java-root" "java-root.el" (20716 7429))
...
(ede-add-project-autoload (ede-project-autoload "lein2" :name "Lein2" :file 'ede/lein2 :proj-file ede-lein2-project-file-name :proj-root 'ede-lein2-project-root :load-type 'ede-lein2-load :class-sym 'ede-lein2-project :new-p nil :safe-p t))
...
;;;***

;;;### (autoloads (ede-m3-install) "ede/m3" "m3.el" (20716 7429))
...
;;;***

;;;### (autoloads (ede-make-check-version) "ede/make" "make.el" (20716
;;;;;;  7429))
...
;;;;;;  "ede/maven2" "maven2.el" (20716 7429))
...
(ede-add-project-autoload (ede-project-autoload "maven2" :name "MAVEN2" :file 'ede/maven2 :proj-file "pom.xml" :proj-root 'ede-maven2-project-root :load-type 'ede-maven2-load :class-sym 'ede-maven2-project :new-p nil :safe-p t))
...
;;;;;;  "ede/system" "system.el" (20716 7429))
...
;;;***

;;;### (autoloads (ede-update-version) "ede/util" "util.el" (20716
;;;;;;  7429))
