;;flymake:实时语法检查
;;Reference: https://github.com/meteor1113/dotemacs/blob/master/init-basic.el
;;需要的外部可执行程序: xelatex, pyflakes
(add-to-list 'load-path "~/.emacs.d/plugin/emacs-flymake")
(load "flymake")
...
(setq flymake-log-file-name "~/.emacs.d/plugin/emacs-flymake.log")
...
(define-key flymake-mode-map (kbd "C-c M-c")
...
;;   (list "xelatex" (list "-file-line-error" "-interaction=nonstopmode" file-name)))

;; (when (executable-find "xelatex")
;;   (add-to-list 'flymake-allowed-file-name-masks
;;                '("\\.tex\\'" flymake-simple-tex-init flymake-master-cleanup ))
;;   (add-to-list 'flymake-allowed-file-name-masks
;;                '("[0-9]+\\.tex\\'"
